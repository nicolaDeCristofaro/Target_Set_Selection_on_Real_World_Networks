...
#Probability distribution functions to compare: constant=0.5, constant=0.8, random, degree_based
...
G2 = snap.LoadEdgeList(snap.TUNGraph, twitchDatasetPath, 0, 1, ',')
...
plt.legend( (bar1, bar2, bar3, bar4, bar5), ('Original', 'Const 0.5', 'Const 0.8', 'Random', 'Degree_Based') )
plt.show()